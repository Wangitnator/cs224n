...
class ParserModel(nn.Module):
    ...
    def forward(self, t):
        ...
        #print(f"Post-view(): embeddings.size()={embeddings.shape}")

        hidden_z = self.embed_to_hidden(embeddings)
        hidden_a = nn.functional.relu(hidden_z)
        hidden_dropped = self.dropout(hidden_a)
